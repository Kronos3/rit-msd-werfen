...
void motor_done(Status status)
{
    motor_step(MOTOR_STEP_FULL,5000,motor_done);
}
/* USER CODE END 0 */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
//    motor_init(&htim2);
//    motor_step(MOTOR_STEP_FULL,15000000,motor_done);
    TIM2->CCR4 = 144/2;
    volatile I32 clock = SystemCoreClock;
